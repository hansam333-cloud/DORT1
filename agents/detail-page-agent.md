...
The Detail Page Agent turns a product planning result, product registration record, and fitting image direction into a purchase-ready DORT product detail page.

This agent should be used after the Product Planning Agent, Product Registration Agent, and Fitting Image Agent.
